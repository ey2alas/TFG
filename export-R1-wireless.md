# Configuració R1 Wireless
```
# may/14/2019 13:47:49 by RouterOS 6.43.13
...
add action=create-dynamic-enabled disabled=yes hw-supported-modes=ac \
    master-configuration="5GHz DHCP" name-format=prefix-identity name-prefix=\
    wlan
...
/system ntp client
set enabled=yes primary-ntp=158.227.98.15 secondary-ntp=5.135.3.88
```
